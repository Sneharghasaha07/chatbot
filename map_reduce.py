from langchain.embeddings.sentence_transformer import SentenceTransformerEmbeddings;from langchain.vectorstores import Chroma;from langchain.chat_models import ChatOpenAI;from decouple import config
