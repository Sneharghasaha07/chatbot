from langchain.embeddings.sentence_transformer import SentenceTransformerEmbeddings;from langchain.prompts import PromptTemplate;from langchain.chat_models import ChatOpenAI;from langchain.chains import RetrievalQA
