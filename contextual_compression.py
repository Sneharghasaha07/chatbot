from langchain.embeddings.sentence_transformer import SentenceTransformerEmbeddings;from langchain.vectorstores import Chroma;from langchain.llms import OpenAI;from langchain.retrievers.document_compressors import LLMChainExtractor
...
llm = OpenAI(temperature=0, openai_api_key=config("kkk"))
